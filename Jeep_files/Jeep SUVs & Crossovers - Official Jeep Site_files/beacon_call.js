(function() {
	...
	function setBeaconUrl(w, doc) {
					w.turn_beacon_url = "https://r.turn.com/r/beacon?";
							w.turn_beacon_data = "rlsr2CTEJyxygqjklYT-K-K9O1tse82FpYeHZKl3EOJciB70BAvMzExeWLlMiarnmrjJGMlFkUdhpRn0_cVZVA";
	...
	function afterBeaconImg(doc) {
							...
							doc.write('<!-- Jeep.brand -->\n<img src="https://r.turn.com/r/beacon?b2=4QJSI6goJJzo7DplWMAlkenKjvrt31D8t6sPddAnv4JciB70BAvMzExeWLlMiarn-6hRUy7G2-iEotocKVpQDQ">\n<!-- End Jeep.brand -->')
